...
The full list of required changes to convert a Manifest V2 extension to Manifest V3 can be found in our [WebExtension API documentation](https://webextension-api.thunderbird.net/en/128-esr-mv3/changes/esr128.html).
