...
* **style** Use an experiment to monitor open windows, and inject the style through that experiment. See our [experiment example](https://github.com/thundernest/sample-extensions/blob/master/experiment/implementation.js#L29-L31).
