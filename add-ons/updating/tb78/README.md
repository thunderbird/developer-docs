...
* **content**, **skin**, **resource**  
  ...
  Inside experimental APIs some calls do not work with `file://*` URLs \(e.g. `new ChromeWorker()`\) , here one needs to manually register a `chrome://*` URL, as shown in our [WindowListener API](https://github.com/cleidigh/ThunderStorm/blob/6a13d6a6e04e64e601a81fbea0986db9658bdc54/examples/MailExtensions/WindowListener/api/WindowListener/implementation.js#L28-L38) example.  
