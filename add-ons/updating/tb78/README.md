...
* **style** Use an experiment to monitor open windows, and inject the style through that experiment. See our [restart example](https://github.com/thundernest/sample-extensions/blob/master/restart/implementation.js). 
...
* Overlays extending the user interface beyond the built-in APIs:
  * [Example](https://github.com/thundernest/sample-extensions/blob/master/restart/implementation.js) for an experimental API with a window listener to manually add UI elements.
...
1. Manually inject the button, menuitem or whatever is opening the dialog via a window listener experiment \(see our [restart example](https://github.com/thundernest/sample-extensions/blob/master/restart/implementation.js)\).
