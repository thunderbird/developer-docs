...
It is now mandatory to register an internal URL, for example a `resource://` URL. See our [Experiment API example](https://github.com/thunderbird/webext-examples/tree/master/manifest_v2/experiment).
