...
{% hint style="info" %}
For most common scenarios, you can use the messaging system provided by the [notifyTools](https://github.com/thunderbird/addon-developer-support/tree/master/auxiliary-apis/NotifyTools) to fix e10s related issues.
{% endhint %}

* **If you access your background page from an experiment** running in the main Thunderbird process ("parent"), you need to switch to an e10s-compatible method to do so. For most common cases, you can use [notifyTools](https://github.com/thunderbird/addon-developer-support/tree/master/auxiliary-apis/NotifyTools).
