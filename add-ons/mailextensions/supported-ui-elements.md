...
If the action button is defined as a [menu typed action button](https://github.com/thunderbird/webext-examples/tree/master/manifest\_v3/menuActionButton), it will open a drop-down menu when clicked.&#x20;
